...
--exercicio3
SELECT 
      MIN(ValorUnitario) AS 'Menorpreço',
	 MAX(ValorUnitario) AS 'Maiorpreço'
FROM
    PRODUTOS;

--exercicio4
SELECT 
     NumeroPedido AS 'Número_Pedido',
	CodigoProduto AS 'Código_Produto',
...
SELECT 
	 ...
	 UF As 'Estado',
	 CNPJ AS 'CNPJ',
	 IE AS 'Número_de_inscrição_estadual' 
...
--exercicio9
SELECT 
     C.CodigoCliente AS 'Código_Cliente',
